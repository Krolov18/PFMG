...
parametrize = pytest.mark.parametrize("params, expected", [
    ...
    ({"source": {"N": [frozendict({"Genre": "m", "m": "Genre", "Nombre": "sg", "sg": "Nombre"}),
                       frozendict({"Genre": "m", "m": "Genre", "Nombre": "pl", "pl": "Nombre"}),
                       frozendict({"Genre": "f", "f": "Genre", "Nombre": "sg", "sg": "Nombre"}),
                       frozendict({"Genre": "f", "f": "Genre", "Nombre": "pl", "pl": "Nombre"})]},
      "destination": {"N": [frozendict({"Cas": "m", "m": "Cas"})]}},
     [{"destination": frozendict({"Cas": "m", "m": "Cas"}),
       "source": frozendict({"Genre": "m", "m": "Genre", "Nombre": "sg", "sg": "Nombre"})},
      {"destination": frozendict({"Cas": "m", "m": "Cas"}),
       "source": frozendict({"Genre": "m", "m": "Genre", "Nombre": "pl", "pl": "Nombre"})},
      {"destination": frozendict({"Cas": "m", "m": "Cas"}),
       "source": frozendict({"Genre": "f", "f": "Genre", "Nombre": "sg", "sg": "Nombre"})},
      {"destination": frozendict({"Cas": "m", "m": "Cas"}),
       "source": frozendict({"Genre": "f", "f": "Genre", "Nombre": "pl", "pl": "Nombre"})}]),
])

...
def test_read_blocks_empty(blocks, att_vals, expected) -> None:
    with pytest.raises(ValueError):
        _ = _read_blocks(blocks, att_vals)
...
def test_read_blocks(blocks, att_vals, expected) -> None:
    actual = _read_blocks(blocks, att_vals)
...
def fx_blocks(request, fx_gloses) -> Dict[str, Dict[str, TypeBlocks]]:
    ...
    return read_blocks(request.param, att_vals)
...
@pytest.mark.parametrize("expected", [
    [Lexeme(stem=('katiSa',), pos='N', sigma=frozendict({'Genre': 'A'}), traduction=Lexeme(stem=('Katisha',), pos='N',
                                                                                           sigma=frozendict(
                                                                                               {'þCF': 'þ1',
                                                                                                'þGenre': 'þF'}),
                                                                                           traduction=None)),
     Lexeme(stem=('padaN',), pos='N', sigma=frozendict({'Genre': 'A'}), traduction=Lexeme(stem=('viande',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('toSik',), pos='N', sigma=frozendict({'Genre': 'A'}), traduction=Lexeme(stem=('fruit',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('modak',), pos='N', sigma=frozendict({'Genre': 'A'}), traduction=Lexeme(stem=('infirmière',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('gatok',), pos='N', sigma=frozendict({'Genre': 'A'}), traduction=Lexeme(stem=('balai',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('pebiz',), pos='N', sigma=frozendict({'Genre': 'A'}), traduction=Lexeme(stem=('plaine',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('nikol',), pos='N', sigma=frozendict({'Genre': 'B'}), traduction=Lexeme(stem=('Nicole',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ1',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('minet',), pos='N', sigma=frozendict({'Genre': 'B'}), traduction=Lexeme(stem=('autruche',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('SeNon',), pos='N', sigma=frozendict({'Genre': 'B'}), traduction=Lexeme(stem=('souris',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ1',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('sapum',), pos='N', sigma=frozendict({'Genre': 'B'}), traduction=Lexeme(stem=('coussin',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('gitun',), pos='N', sigma=frozendict({'Genre': 'B'}), traduction=Lexeme(stem=('chambre',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('maren',), pos='N', sigma=frozendict({'Genre': 'B'}), traduction=Lexeme(stem=('thé',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('diNol',), pos='N', sigma=frozendict({'Genre': 'C'}), traduction=Lexeme(stem=('chasseur',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('minut',), pos='N', sigma=frozendict({'Genre': 'C'}), traduction=Lexeme(stem=('fille',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('Zerom',), pos='N', sigma=frozendict({'Genre': 'C'}), traduction=Lexeme(stem=('oeuf',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('felot',), pos='N', sigma=frozendict({'Genre': 'C'}), traduction=Lexeme(stem=('café',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('potaS',), pos='N', sigma=frozendict({'Genre': 'C'}), traduction=Lexeme(stem=('coyote',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('kasab',), pos='N', sigma=frozendict({'Genre': 'C'}), traduction=Lexeme(stem=('village',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('nabil',), pos='N', sigma=frozendict({'Genre': 'D'}), traduction=Lexeme(stem=('Nabil',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ1',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('mesaZ',), pos='N', sigma=frozendict({'Genre': 'D'}), traduction=Lexeme(stem=('garçon',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('pulop',), pos='N', sigma=frozendict({'Genre': 'D'}), traduction=Lexeme(stem=('cuisine',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('Nazon',), pos='N', sigma=frozendict({'Genre': 'D'}), traduction=Lexeme(stem=('table',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     Lexeme(stem=('rumak',), pos='N', sigma=frozendict({'Genre': 'D'}),
            traduction=Lexeme(stem=('chat', 'chatte'), pos='N', sigma=frozendict({'þCF': 'þ2'}),
                              traduction=None)),
     Lexeme(stem=('gobid',), pos='N', sigma=frozendict({'Genre': 'D'}), traduction=Lexeme(stem=('lit',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þM'}),
                                                                                          traduction=None)),
     Lexeme(stem=('kuroz',), pos='N', sigma=frozendict({'Genre': 'D'}), traduction=Lexeme(stem=('maison',), pos='N',
                                                                                          sigma=frozendict({'þCF': 'þ2',
                                                                                                            'þGenre': 'þF'}),
                                                                                          traduction=None)),
     ...
     Lexeme(stem=('l',), pos='DET', sigma=frozendict({}),
            traduction=Lexeme(stem=('ce', 'cette', 'ces', 'cet'), pos='DET', sigma=frozendict({'þDEF': 'þDEM'}),
                              traduction=None)),
